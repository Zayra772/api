<?php
	...
	function enviarEmail($email, $nombre, $asunto, $cuerpo){
		...
		$mail->Username = 'jhonnasanchez68@gmail.com'; //Modificar CON CUENTA
		$mail->Password = 'Jonathan18'; //Modificar CON clave DE CORREO
		
		$mail->setFrom('jhonnasanchez68@gmail.com', 'Aldahir-IRD41'); //Modificar CON SU CIENTA Y CATCHA
